...
function LandingPage() {
  ...
  return (
   ...
   <LandingPageNavbar />
    ...
    <div className='md:grid grid-cols-2 md:p-20 p-5  justify-center content-center'>
    <div className='flex flex-col justify-center md:p-10' data-aos = "fade-up">
      <h1 className='justify-center items-center md:p-10 text-7xl font-extrabold font-serif bg-gradient-to-r from-blue-600 via-sky-500 inline-block text-transparent bg-clip-text' >About Us</h1>
      <p className=''></p>
    </div>
      <div className='h-auto flex flex-col justify-center md:p-10 gap-3 bg-opacity-60 bg-gradient-to-br from-myblue to-sky-500 border rounded-md' >
    ...
    <div className='md:grid grid-cols-4 md:p-20 p-5  justify-center content-center gap-3'  data-aos = "fade-up">
      <div className='border rounded-md h-auto flex flex-col justify-center md:p-10 gap-3 hover:bg-gradient-to-br from-myblue to-sky-500'> 
          <h1 className='font-semibold text-center'>NEET BATCH</h1>
          <p>Target Group - Students who completed STD XII
      ...
      <div className='border rounded-md h-auto flex flex-col justify-center md:p-10 gap-3 hover:bg-gradient-to-br from-myblue to-sky-500'>
        ...
        <p>Target Group - Students who completed STD X
          Duration - Two Year
          Class Timing: 8.30 am – 5.00 pm
      ...
      <div className='border rounded-md h-auto flex flex-col justify-center md:p-10 gap-3 hover:bg-gradient-to-br from-myblue to-sky-500'>
        <h1 className='font-semibold text-center'>MEDICAL / ENGINEERING CRASH COURSE</h1>
        <p>Target Group - Students who awaiting STD XII Result
      ...
      <div className='border rounded-md h-auto flex flex-col justify-center md:p-10 gap-3 hover:bg-gradient-to-br from-myblue to-sky-500'>
        <h1 className='font-semibold text-center'>+1 SCIENCE TUITION (KERALA BOARD & CBSE)</h1>
        <p>Target Group - Students who completed STD XI
      ...
      <div className='border rounded-md h-auto flex flex-col justify-center md:p-10 gap-3 hover:bg-gradient-to-br from-myblue to-sky-500'>
        <h1 className='font-semibold text-center'>+2 SCIENCE TUITION (KERALA BOARD & CBSE)</h1>
        <p>Target Group - Students who completed STD X
      ...
      <div className='border rounded-md h-auto flex flex-col justify-center md:p-10 gap-3 hover:bg-gradient-to-br from-myblue to-sky-500'>
        ...
        <p>Target Group - Students who studied in STD XI or XII
